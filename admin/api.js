import { portalConfig } from '../firebase-config.js?v=20260920-registration-ui-r1';
import { adminState } from './state.js?v=20260920-registration-ui-r1';
import { createAdminApiClient } from './request-client.js?v=20260920-registration-ui-r1';
