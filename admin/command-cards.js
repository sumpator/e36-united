import { escapeHtml as esc } from './ui.js?v=20260909-admin-command-r3';
import { showValue } from './dashboard-data.js?v=20260909-admin-command-r3';
...
import { formatDate } from './ui.js?v=20260909-admin-command-r3';
