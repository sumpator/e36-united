import { commandBadges, BADGE_SCOPE } from './command-model.js?v=20260924-merch2';
...
export function initializeCommandShell() {
  ...
  for(const nav of document.querySelectorAll('.admin-section-nav,.portal-nav-sheet-list'))nav.querySelector('[data-portal-target="live"]').insertAdjacentHTML('beforebegin',navButton('merch','Merchandising'));
