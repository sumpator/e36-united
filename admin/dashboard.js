...
import {adminCommand,bindCurrentEditors,forgetAdminEditor,editorProtected,allowAdminNavigation,adminEditorDirty} from './editors.js?v=20260922-live4';
import {COMPOSITIONS,validatePreferences} from './dashboard-model.js?v=20260922-live4';
import {COMMAND_WIDGETS as WIDGETS,commandDefaults as factoryPreferences,commandLayout,commandBadges} from './command-model.js?v=20260922-live4';
import {commandCard,metricInfo} from './command-cards.js?v=20260922-live4';
import {commandIcon} from './command-icons.js?v=20260922-live4';
import {renderCommandShell} from './command-shell.js?v=20260922-live4';
import {DESTINATIONS,QUICK_LINK_IDS,destination,drillLabel} from './destinations.js?v=20260922-live4';
import {dashboardKpi,chartModel,attentionModel,showValue} from './dashboard-data.js?v=20260922-live4';
import {$,escapeHtml as esc,toast} from './ui.js?v=20260922-live4';
import {createCardMedia} from './member-cards.js?v=20260922-live4';
