...
export const DESTINATIONS=Object.freeze({
  ...
  reservations:{label:'Všechny registrace',view:'reservations'},
  active:{label:'Aktivní registrace · pending + approved',view:'reservations',scope:'active'},
  pending:{label:'Čekající registrace',view:'reservations',scope:'pending'},
  reservationApprovals:{label:'Rezervační schvalování',view:'reservations',scope:'approvals'},
  approved:{label:'Schválené registrace',view:'reservations',scope:'approved'},
  rejected:{label:'Zamítnuté registrace',view:'reservations',scope:'rejected'},
  cancelled:{label:'Zrušené registrace',view:'reservations',scope:'cancelled'},
  draft:{label:'Koncepty registrací',view:'reservations',scope:'draft'},
  outstanding:{label:'Aktivní registrace se zbývající úhradou',view:'payments',scope:'outstanding'},
  overdue:{label:'Schválené registrace po splatnosti',view:'payments',scope:'overdue'},
  ...
  activePaid:{label:'Úhrady aktivních registrací',view:'payments',scope:'activePaid'},
  inactivePaid:{label:'Úhrady mimo aktivní registrace',view:'payments',scope:'inactivePaid'},
  activeDue:{label:'Předpis aktivním registracím',view:'payments',scope:'activeDue'},
