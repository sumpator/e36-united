...
import {escapeHtml as esc,formatMoney,formatDate} from './ui.js?v=20260911-finish-ui-r1';
import {commandIcon} from './command-icons.js?v=20260911-finish-ui-r1';
...
export const memberReservationLink=item=>`<button type="button" data-member-reservation="${esc(item.id)}" data-member-event-id="${esc(item.eventId)}">Otevřít detail rezervace</button>`;
