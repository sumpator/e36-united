...
import { selectImageFiles } from '../../image-upload.js?v=20260908-admin-member2';
import { apiBaseUrl, apiRequest, apiUpload } from '../api.js?v=20260908-admin-member2';
import { adminState } from '../state.js?v=20260908-admin-member2';
import { setDenied } from '../shell.js?v=20260908-admin-member2';
import { $, escapeHtml, formatMoney, numeric, toast } from '../ui.js?v=20260908-admin-member2';
