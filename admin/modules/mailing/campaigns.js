...
import { $, escapeHtml, formatDate, numeric, toast } from '../../ui.js?v=20260912-reservation-workflow-r1';
import { activeMailingCampaignId, initializeMailingEditor, markMailingEditorSaved, openMailingEditorDraft, resetMailingEditor } from './editor.js?v=20260912-reservation-workflow-r1';
import { initializeMailingDelivery, openMailingDelivery, resetMailingDelivery } from './delivery.js?v=20260912-reservation-workflow-r1';
import { defaultMailingSegment } from './segments.js?v=20260912-reservation-workflow-r1';
