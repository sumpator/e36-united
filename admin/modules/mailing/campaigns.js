...
import { $, escapeHtml, formatDate, numeric, toast } from '../../ui.js?v=20260908-admin-member2';
import { activeMailingCampaignId, initializeMailingEditor, markMailingEditorSaved, openMailingEditorDraft, resetMailingEditor } from './editor.js?v=20260908-admin-member2';
import { initializeMailingDelivery, openMailingDelivery, resetMailingDelivery } from './delivery.js?v=20260908-admin-member2';
import { defaultMailingSegment } from './segments.js?v=20260908-admin-member2';
