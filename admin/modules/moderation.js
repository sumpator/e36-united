...
import {compactMemberIdentity,compactMemberPhoto,createCardMedia} from '../member-cards.js?v=20260912-accommodation-gallery-r1';
...
import { adminCommand, editorProtected, forgetAdminEditor } from '../editors.js?v=20260912-accommodation-gallery-r1';
import { apiMedia, apiRequest } from '../api.js?v=20260912-accommodation-gallery-r1';
...
import { $, $$, escapeHtml, formatDate, galleryStatusLabel, numeric, photosLabel, recordsLabel, rememberSessionChoice, toast } from '../ui.js?v=20260912-accommodation-gallery-r1';
