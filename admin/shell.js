...
import { initPortalNavigation } from '../portal-navigation.js?v=20260910-admin-card-ux-r1';
import { ADMIN_VIEW_IDS } from '../admin-view-model.js?v=20260910-admin-card-ux-r1';
import {ADMIN_AREAS,VIEW_LABELS,areaFor} from './destinations.js?v=20260910-admin-card-ux-r1';
import { adminState } from './state.js?v=20260910-admin-card-ux-r1';
import { $, $$, rememberSessionChoice } from './ui.js?v=20260910-admin-card-ux-r1';
