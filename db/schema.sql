-- E36 United production D1 application schema baseline.
-- Verified read-only on 2026-08-31 from sqlite_master and schema PRAGMAs.
-- Contains schema objects only; no production rows.
