...
**Operator acceptance clarification — 2026-09-08:** Stage 2 and targeted optimization checkpoint `688441b15540623fe416e704b985f04fd2999f9f` are accepted for handoff with the 1M synthetic target formally UNMET (3,904,805 conservative estimated row operations including 10% reserve; not Cloudflare `meta.rows_read`). Expected visible usage is ~3 total admin-browser-hours/week normally and ~10–12/event day; 3-admin/12h and 24h models remain stress/sensitivity scenarios. No further Stage 2 optimization is authorized merely to meet 1M. The Free-tier cadence amendment above remains authoritative. Stage 3 must measure its own incremental dashboard/query cost and reuse the coordinator/canonical resources; no widget/chart may add an independent polling timer or reopen broad Stage 2 optimization. See [budget decision](admin-v2-free-tier-budget.md) and [progress](admin-v2-progress.md). This does not authorize Stage 3/4 execution or rollout.
