...
## Production rollout resumed — 2026-09-09, VERIFIED within bounded read-only smoke

Direct operator chat authorization resolved the earlier execution gate. Starting clean main `ad17caa062a002533a647654bbc815a9537a7862` was a verified documentation-only descendant of approved application/origin `1a89afdab10b76c9c6c80a1115bf2bb8ae66dc65`. Fresh production/recovery checks matched the recorded baseline. All four exact Admin migrations were newly applied in dependency order and verified; the complete approved Worker is active at 100% as version `52a48e0b-3c3b-4ba6-8a2a-37e199e246ef`, deployment `45a9b967-8d59-49f3-8f43-e758990bdf6e`. Configuration/bindings/routes/private R2 were preserved. Public and existing-session Admin read smoke passed; prior dashboard/member unavailability was no longer observed. QR remains intentionally unissued for all five existing members. No business mutations or preference saves were tested. Existing reservation detail (zero records), complete browser network capture and production hidden-tab verification remain unavailable. See [resumed rollout evidence and limitations](admin-v2-production-rollout.md#resumed-rollout--2026-09-09-direct-operator-authorization). The previously completed unchanged local gate was reused, not rerun. No push/Pages deployment, redesign/Stage4 or reopening of the accepted Stage2 budget.
