...
function renderReservation(){
  ...
  $('[data-reservation-state-label]').textContent=`Stav rezervace: ${statusText}`;$('[data-reservation-year]').textContent=r.year||'NEXT';$('[data-reservation-title]').textContent=r.title||'E36 United';
